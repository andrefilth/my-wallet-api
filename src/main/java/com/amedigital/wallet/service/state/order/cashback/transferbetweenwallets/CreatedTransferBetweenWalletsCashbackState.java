...
@Service
public class CreatedTransferBetweenWalletsCashbackState  implements SecondaryOrderState<TransferBetweenWalletsOrder, CashbackOrder> {

    private final OrderRepository repository;

    @Autowired
    public CreatedTransferBetweenWalletsCashbackState(OrderRepository repository) {
