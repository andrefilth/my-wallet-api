...
@Service
public class CapturedTransferBetweenWalletsCashbackState  implements SecondaryOrderState<TransferBetweenWalletsOrder, CashbackOrder> {

    private final OrderRepository repository;

    @Autowired
    public CapturedTransferBetweenWalletsCashbackState(OrderRepository repository) {
