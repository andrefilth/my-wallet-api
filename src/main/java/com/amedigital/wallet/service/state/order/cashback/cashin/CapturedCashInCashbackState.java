...
@Service
public class CapturedCashInCashbackState implements SecondaryOrderState<CashInOrder, CashbackOrder> {

    private final OrderRepository repository;

    @Autowired
    public CapturedCashInCashbackState(OrderRepository repository) {
